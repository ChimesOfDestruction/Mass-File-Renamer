...
namespace Ambiance
{
	internal class Ambiance_Button_2 : Control
	{
		...
		public Ambiance_Button_2()
		{
			...
			this.P1 = new Pen(Color.FromArgb(162, 120, 101));
		}
		...
		protected override void OnPaint(PaintEventArgs e)
		{
			...
			PointF pointF = Ambiance_Button_2.ImageLocation(this.GetStringFormat(this.ImageAlign), base.Size, this.ImageSize);
		...
		protected override void OnResize(EventArgs e)
		{
			if ((base.Width <= 0 ? false : base.Height > 0))
			{
				...
				this.InactiveGB = new LinearGradientBrush(new Rectangle(0, 0, base.Width, base.Height), Color.FromArgb(253, 175, 143), Color.FromArgb(244, 146, 106), 90f);
				this.PressedGB = new LinearGradientBrush(new Rectangle(0, 0, base.Width, base.Height), Color.FromArgb(244, 146, 106), Color.FromArgb(244, 146, 106), 90f);
				this.PressedContourGB = new LinearGradientBrush(new Rectangle(0, 0, base.Width, base.Height), Color.FromArgb(162, 120, 101), Color.FromArgb(162, 120, 101), 90f);
